const CharacterCard = ({ img, name, status, species }) => {
    return (
        <div className="flex flex-col justify-around items-center flex-wrap gap-y-3 py-4 mb-4 mx-4 h-110 shadow-[0px_0px_15px_-1px_rgba(255,255,255,0.49)] rounded-[20px]">
            <div>
