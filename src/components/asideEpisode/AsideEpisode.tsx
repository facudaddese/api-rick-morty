...
interface AsideEpisodeProps {
  episodes: EpisodeResults[] | null;
  setEpisode: React.Dispatch<React.SetStateAction<EpisodeResults | null>>;
}

const AsideEpisode = ({ episodes, setEpisode }: AsideEpisodeProps) => {
  return (
