...
interface AsideLocationProps {
  locations: LocationResults[] | null;
  setLocation: React.Dispatch<React.SetStateAction<LocationResults | null>>;
}

const AsideLocation = ({ locations, setLocation }: AsideLocationProps) => {
  return (
    <aside className="[grid-area:aside] px-5 flex flex-col self-center h-95 overflow-hidden overflow-y-auto gap-4 py-3 w-63 aside-location">
